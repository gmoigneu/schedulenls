    ...
    <section id="wrapper">
        <div class="login-register">
            <div class="login-box card">
                <h1 class="text-center">scdl.me</h1>   
                <h4 class="text-center">100% free personal meeting scheduler</h4>         
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" action="/login" method="GET">
                        <div class="form-group text-center">
                            <div class="col-xs-12 p-b-20">
                                <button class="btn btn-block btn-lg btn-info btn-rounded" type="submit">Sign in with Google</button>
                            </div>
                        </div>
                    </form>
                </div>
